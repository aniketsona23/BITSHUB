...
class CommentTable(models.Model):
    query = models.ForeignKey('DoubtTable', models.DO_NOTHING, blank=True, null=True)
...
class MainTable(models.Model):
    ...
    ans = models.CharField(max_length=50, blank=True, null=True)
...
class TopicsTable(models.Model):
    ...
    topics = models.TextField()  # This field type is a guess.
    topic_ids = models.TextField()  # This field type is a guess.
